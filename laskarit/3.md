...
**Protip2** testien suoritus oikean selaimen avulla on melko hidasta. Voit nopeuttaa testien suoritusta käyttämällä chromen sijaan käyttöliittymätöntä selainta _HtmlUnitDriver:iä_. Katso lisää [täältä](https://github.com/mluukkai/ohjelmistotuotanto2018/blob/master/web/selenium_troubleshooting.md#tapa-1-htmlunit-driver)
